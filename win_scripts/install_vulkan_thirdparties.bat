...
xcopy "source_codes\Vulkan-Headers_1.3.250.1\include" "libs_win\Vulkan-Headers_1.3.250.1\include" /Y /E /H /C /I

xcopy "source_codes\imgui-1.90" "libs_win\imgui-1.90\" /Y /E /H /C /I
