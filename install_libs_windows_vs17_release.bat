...
cd %CURR_DIR%
call win_scripts\install_eigen3_4_0.bat %BUILD_TYPE%
echo Eigen Done!

cd %CURR_DIR%
call win_scripts\install_fmt_10_1_1.bat %BUILD_TYPE%
echo install_fmt_10_1_1 Done!

cd %CURR_DIR%
call win_scripts\install_sophus_1_22_10.bat %BUILD_TYPE%
